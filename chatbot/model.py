...
from .data import faq_data, bursary_data, registry_data, courses_data, exam_schedule_data, school_fees_data
...
def handle_query(prompt):
 messages = [
     ChatMessage(role="user", content=f"""
      ...
      you shall answer question(s) accurately below using only these {faq_data}, {bursary_data}, {registry_data},{courses_data}, {exam_schedule_data}, {school_fees_data}  as your source of truth, 
      ...
      do not make up any information not inside of these sources {faq_data}, {bursary_data}, {registry_data}, {courses_data}, {exam_schedule_data}, {school_fees_data}
